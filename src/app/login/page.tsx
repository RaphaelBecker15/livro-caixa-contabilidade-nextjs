        ...
        <div className="min-h-screen bg-slate-100 flex items-center justify-center p-4">
            <div className="bg-white p-8 rounded-2xl shadow-xl w-full max-w-md">
                <div className="text-center mb-8">
                    ...
                    <h1 className="font-bold text-2xl pt-4" style={{color: '#394071'}}>Login</h1>
                </div>
                <form className="space-y-4">
                    <input type="text" placeholder="Usuário/Email" className="w-full px-4 py-2 border rounded-md bg-white text-neutral-900 text-sm font-light"/>
